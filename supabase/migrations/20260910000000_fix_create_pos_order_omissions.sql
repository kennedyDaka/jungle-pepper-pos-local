-- Fix create_pos_order: add qty when inserting omissions
-- Matches create_waiter_order pattern — looks up recipe to compute omission_qty
...
begin
  ...
  for line in select * from jsonb_array_elements(item_lines) loop
    ...
    -- omissions (FIXED: look up recipe to compute qty)
