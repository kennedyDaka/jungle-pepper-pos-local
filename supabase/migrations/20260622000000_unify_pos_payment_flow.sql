-- Allow process_payment to accept empty payments when total = 0
-- (needed for staff meals and the unified POS flow where the order
--  is created first via create_waiter_order, then paid via process_payment)
