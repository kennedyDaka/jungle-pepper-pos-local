-- Fix ON CONFLICT ambiguity in all three order-creation RPCs.
-- PostgreSQL 17 with variable_conflict = error can't distinguish
-- between a column name and a <<func>> block variable in
-- ON CONFLICT (order_item_id, modifier_id).
-- Fix: use constraint-name syntax instead.

-- ============================================================
-- 1. Fix create_pos_order
-- ============================================================
