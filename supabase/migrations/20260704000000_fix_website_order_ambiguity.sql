-- Fix create_website_order: add <<func>> block label, qualify ambiguous column refs,
-- and add ON CONFLICT DO NOTHING for modifier inserts (parity with create_pos_order / create_waiter_order)
