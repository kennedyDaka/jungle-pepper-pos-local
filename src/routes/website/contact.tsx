  ...
  head: () => ({
    meta: [
      { title: "Contact — Jungle Pepper" },
      {
        name: "description",
        content:
          "Get in touch with Jungle Pepper in Blantyre, Malawi. Call or visit us on Kidney Crescent Road.",
      },
    ],
  }),
    ...
    <div>
      ...
      <section className="mx-auto grid max-w-4xl gap-8 px-4 py-10 sm:gap-12 sm:py-16 md:grid-cols-2">
        <div className="space-y-6 text-sm sm:text-base">
          <div>
            <h2 className="font-display text-xl text-[color:var(--brand-red)] sm:text-2xl">
              Location
            </h2>
          ...
          <div>
            ...
            <p className="mt-1">
              <a href="tel:+265999826229" className="text-lg font-semibold hover:underline">
                0999 826 229
              </a>
            </p>
            <p>
              <a href="tel:+265888826229" className="text-lg font-semibold hover:underline">
                0888 826 229
              </a>
            </p>
          </div>
          <div>
            ...
            <p className="mt-1">
              ...
              {" · "}
              <a
                href="https://facebook.com/junglepeppermw"
                target="_blank"
                rel="noreferrer"
                className="font-semibold hover:underline"
              >
              ...
              {" · "}
              <a
                href="https://instagram.com/jungle_pepper_mw"
                target="_blank"
                rel="noreferrer"
                className="font-semibold hover:underline"
              >
