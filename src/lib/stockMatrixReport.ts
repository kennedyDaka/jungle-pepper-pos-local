...
const FOOD_ROWS: MatrixRowDef[] = [
  ...
  { kind: "section", label: "P A S T A" },
  { kind: "stock", label: "SPAGHETTI (Kg)", aliases: ["SPAGHETTI"], highlight: true },
  { kind: "stock", label: "PENNE (Kg)", aliases: ["PENNE"], highlight: true },
  { kind: "stock", label: "FETTUCCINE (Kg)", aliases: ["FETTUCCINE"], highlight: true },
