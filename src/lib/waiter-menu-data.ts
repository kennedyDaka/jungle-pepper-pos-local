...
const I = (
  ...
  id, name, dbName, page, x, y, w, h, price, kind,
});

export const MENU: MenuItem[] = [
  I("garlic-loaf", "Garlic Loaf", "Garlic Loaf", 1, 40, 140, 320, 35, 14500),
  I("garlic-loaf-cheese", "Garlic Loaf & Cheese", "Garlic Loaf and Cheese", 1, 40, 196, 320, 35, 15500),
  ...
  I("pasta-creamy-chicken", "Creamy Chicken & Mushroom Pasta", "Creamy Chicken and Mushroom", 2, 40, 353, 325, 40, 27000, "pasta"),
  I("pasta-creamy-prawn", "Creamy Tomato & Prawn Pasta", "Creamy Tomato and Prawn", 2, 40, 397, 325, 40, 37000, "pasta"),
  ...
  I("pizza-portuguese", "Portuguese Chicken Pizza", "Portuguese Chicken Pizza", 3, 40, 444, 180, 40, 32900, "pizza"),
  I("pizza-chicken-mushroom", "Chicken Mushroom Pizza", "Chicken Mushroom Pizza", 3, 40, 488, 180, 33, 32900, "pizza"),
  I("pizza-sweet-sour", "Sweet & Sour Safari Pizza", "Sweet and Sour Safari Pizza", 3, 40, 521, 180, 40, 32900, "pizza"),
  ...
  I("pizza-vegetarian", "Vegetarian Pizza", "Vegetarian Pizza", 3, 235, 345, 150, 42, 32900, "pizza"),
  ...
  I("pizza-medit", "Mediterranean Pizza", "Mediterranean Pizza", 3, 235, 669, 150, 55, 32900, "pizza"),
  ...
  I("churrasco-half", "Churrasco Half Chicken", "Half Churrasco Chicken", 5, 195, 624, 180, 18, 38000),
  I("churrasco-full", "Churrasco Full Chicken", "Full Churrasco Chicken", 5, 195, 638, 180, 18, 55000),
  ...
  I("dessert-pancakes-ic", "Pancakes with Ice Cream", "Pancakes with Ice Cream", 7, 20, 226, 370, 35, 14900),
...
export type ExtraItem = { id: string; name: string; dbName: string; price: number; category: string };
export type ExtraCategory = { id: string; label: string; items: ExtraItem[] };

const E = (id: string, name: string, dbName: string, price: number, category: string): ExtraItem => ({
  id, name, dbName, price, category,
});
