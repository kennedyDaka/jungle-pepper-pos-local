...
export const MENU: MenuItem[] = [
  I("garlic-loaf", "Garlic Loaf", "Garlic Loaf", 1, 40, 140, 320, 35, 15800),
  I(
    "garlic-loaf-cheese",
    "Garlic Loaf & Cheese",
  ...
  I("focaccia", "Focaccia", "Focaccia", 1, 40, 252, 320, 35, 26800),
  I("focaccia-cheese", "Focaccia & Cheese", "Focaccia and Cheese", 1, 40, 308, 320, 35, 39800),
  I("greek-salad", "Greek Salad", "Greek Salad", 1, 40, 419, 320, 35, 15500),
  ...
  I("pasta-pomodoro", "Pasta Pomodoro", "Pomodoro", 2, 40, 222, 325, 42, 29900, "pasta"),
  I("pasta-picanti", "Pasta Picanti", "Picanti", 2, 40, 266, 325, 42, 29900, "pasta"),
  I("pasta-bolognese", "Pasta Bolognese", "Bolognese", 2, 40, 309, 325, 40, 29800, "pasta"),
  I(
  ...
  I("pizza-katundu", "Katundu Pizza", "Katundu Pizza", 3, 40, 310, 180, 40, 39800, "pizza"),
  I("pizza-mexicano", "Mexicano Pizza", "Mexicano Pizza", 3, 40, 354, 180, 40, 39800, "pizza"),
  I(
    "pizza-portuguese",
  ...
  I("pizza-maffiosa", "Maffiosa Pizza", "Maffiosa Pizza", 3, 40, 565, 180, 30, 39800, "pizza"),
  I("pizza-prawn", "Prawn Pizza", "Prawn Pizza", 3, 40, 654, 180, 40, 41800, "pizza"),
  I("pizza-anchovy", "Anchovy Pizza", "Anchovy Pizza", 3, 40, 698, 180, 30, 39800, "pizza"),
  I(
    "pizza-vegetarian",
    "Vegetarian Pizza",
    "Vegetarian Pizza",
  ...
  I("pizza-vegan", "Vegan Pizza", "Vegan Pizza", 3, 235, 393, 150, 33, 39800, "pizza"),
  I("pizza-margarita", "Margarita Pizza", "Margarita Pizza", 3, 235, 441, 150, 33, 39800, "pizza"),
  I("pizza-piccanti", "Piccanti Pizza", "Piccanti Pizza", 3, 235, 477, 150, 40, 39800, "pizza"),
  I("pizza-jalapeno", "Jalapeno Pizza", "Jalapeno Pizza", 3, 235, 525, 150, 42, 39800, "pizza"),
  I("pizza-hummus", "Hummus Pizza", "Hummus Pizza", 3, 235, 573, 150, 42, 39800, "pizza"),
  I("pizza-godfather", "Godfather Pizza", "Godfather Pizza", 3, 235, 621, 150, 42, 39800, "pizza"),
  I(
    "pizza-medit",
    "Mediterranean Pizza",
    "Mediterranean Pizza",
  ...
  I("burger-jungle", "Jungle Pepper Burger", "Jungle Pepper Burger", 4, 40, 300, 325, 40, 29800),
  I("burger-chicken", "Chicken Burger", "Chicken Burger", 4, 40, 355, 325, 50, 29800),
  I("burger-prawn", "Prawn Burger", "Prawn Burger", 4, 40, 421, 325, 40, 36800),
  I("burger-veggie", "Veggie Burger", "Veggie Burger", 4, 40, 476, 325, 40, 29800),
  I("chips-plain-sm", "Plain Chips (Small)", "Plain Chips Small", 4, 40, 640, 325, 20, 13800),
  I("chips-plain-lg", "Plain Chips (Large)", "Plain Chips Large", 4, 40, 660, 325, 20, 14800),
  I("chips-masala-sm", "Masala Chips (Small)", "Masala Chips Small", 4, 40, 707, 325, 20, 14800),
  I("chips-masala-lg", "Masala Chips (Large)", "Masala Chips Large", 4, 40, 727, 325, 20, 16800),

  I("prego-plain", "Plain Prego", "Plain Prego", 5, 40, 275, 325, 30, 32800),
  I("prego-pimento", "Prego Pimento", "Prego Pimento", 5, 40, 308, 325, 30, 32800),
  I("prego-extra", "Prego Extra Topping", "Extra Chicken Topping", 5, 40, 341, 325, 30, 8000),
  I("beef-bitoque", "Beef Bitoque", "Beef Bitoque", 5, 40, 387, 325, 40, 37900),
  I("chicken-bitoque", "Chicken Bitoque", "Chicken Bitoque", 5, 40, 431, 325, 40, 37900),
  I(
    "churrasco-half",
  ...
  I("paella", "Arroz de Marisco", "Arroz de Marisco", 6, 20, 40, 370, 130, 69800),
  I("camarao-6", "Camarao - 6 Prawns", "Camarao 6 Prawns", 6, 20, 395, 370, 30, 50800),
  I("camarao-12", "Prawns in Shell - 12 Prawns", "Camarao 12 Prawns", 6, 20, 425, 370, 70, 69800),
  ...
  I("italian-cap", "Italian Cappuccino", "Italian Cappuccino", 8, 40, 132, 325, 32, 9500),
  I("brazil-cap", "Brazilian Cappuccino", "Brazilian Cappuccino", 8, 40, 162, 325, 32, 9500),
  I("kiddoccino", "Kiddoccino", "Kiddoccino", 8, 40, 192, 325, 42, 7500),
  I("bica", "Bica (Espresso)", "Bica Espresso", 8, 40, 232, 325, 32, 7500),
  I("railway", "Railway Espresso (Bombom)", "Railway Espresso Bombom", 8, 40, 262, 325, 32, 10500),
  I("carioca", "Carioca", "Carioca", 8, 40, 292, 325, 32, 7500),
  I("macchiato", "Macchiato", "Macchiato", 8, 40, 322, 325, 32, 7500),
  I("pingo", "Pingo", "Pingo", 8, 40, 352, 325, 32, 7500),
  I("babychino", "Babychino", "Babychino", 8, 40, 382, 325, 32, 7500),
  I("galao", "Galao (Caffe Latte)", "Galao Caffe Latte", 8, 150, 428, 215, 32, 10500),
  I("hot-choc", "Hot Chocolate", "Hot Chocolate", 8, 150, 458, 215, 20, 14000),
  I("submarine", "Submarine", "Submarine", 8, 150, 478, 215, 32, 10500),
  I("chocachino", "Chocachino", "Chocachino", 8, 150, 508, 215, 42, 12500),
  I("filter-coffee", "Filter Coffee", "Filter Coffee", 8, 150, 548, 215, 32, 10500),
  I("malawian-tea", "Malawian Tea", "Malawian Tea", 8, 40, 638, 240, 11, 5000),
  I("earl-grey", "Earl Grey", "Earl Grey Tea", 8, 40, 651, 240, 11, 7500),
  I("rooibos", "Rooibos", "Rooibos Tea", 8, 40, 664, 240, 11, 8000),
  I("carioca-limao", "Carioca de Limao", "Carioca de Limao", 8, 40, 677, 240, 11, 7000),
  I("herbal-teas", "Herbal Teas", "Herbal Teas", 8, 40, 690, 240, 11, 8000),
];
